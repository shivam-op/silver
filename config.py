...
BOT_NAME = getenv("BOT_NAME", "Evil music")
...
BOT_USERNAME = getenv("BOT_USERNAME", "Kiritos_music_bot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Kiritos_xD")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "Hindichattinga")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Be_lighthearted")
# isi dengan username kamu tanpa simbol @
OWNER_NAME = getenv("OWNER_NAME", "dlwrml")
# fill with your nickname
ALIVE_NAME = getenv("ALIVE_NAME", "Evil")
...
UPSTREAM_REPO = os.environ.get(
    "UPSTREAM_REPO", "https://github.com/Abhishek79799/Evilmusic"
)
